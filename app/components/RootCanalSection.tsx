...
export default function RootCanalSection() {
  return (
    <section id="root-canal" className="py-14 bg-gradient-to-b from-white to-blue-50/30">
      <div className="max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-gray-600 text-base sm:text-lg">
            If you notice <span className="font-semibold text-gray-900">two or more</span> of these signs, your tooth may be infected.
          </p>
        </motion.div>
